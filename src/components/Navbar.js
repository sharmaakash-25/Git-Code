          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              {!login ? (
                <>
                  <li className="nav-item mx-5">
                    <Link className={`nav-link ${location.pathname === "/login" && "active"}`} aria-current="page" to="/login" style={{ marginLeft: "60px" }}>
                      Login
                    </Link>
                  </li>
                </>
                ...
                <>
                  <li className="nav-item dropdown ms-auto">
                    <Link className="nav-link dropdown-toggle" to="/profile" role="button" data-bs-toggle="dropdown" aria-expanded="false" style={{ marginLeft: "100px" }}>
                      You
                    </Link>
